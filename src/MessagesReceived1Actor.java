...
public class MessagesReceived1Actor extends JFrame {
    ...
    public MessagesReceived1Actor(String name){
        this.name=name;
        ...
        textArea1.setText(String.valueOf(MonitorService.messagesReceivedActor(name)));
        thread.start();
        close();
    }
