...
public class MessagesReceivedAllActors extends JFrame{
    private JPanel allActors;
    private JTextArea textArea1;

    private Thread thread = new Thread(this::run);

    public MessagesReceivedAllActors(){
        ...
        textArea1.setText(String.valueOf(MonitorService.messagesReceivedAllActors()));
        thread.start();
        close();
    }
